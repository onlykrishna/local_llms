...
class PdfChatBubble extends StatelessWidget {
  final PdfChatMessage message;

  const PdfChatBubble({super.key, required this.message});

  void _showOptions(BuildContext context) {
    final isUser = message.role == PdfChatRole.user;
    Get.bottomSheet(
      Container(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                if (message.citations.isNotEmpty) {
                  final citationText = message.citations
