...
class ModelRegistry {
  static const List<ModelDefinition> models = [
    ...
    ModelDefinition(
      ...
      sizeLabel: '3.2GB',
      sizeBytes: 3462677760,
      downloadUrl: 'https://huggingface.co/bartowski/google_gemma-4-E2B-it-GGUF/resolve/main/google_gemma-4-E2B-it-Q4_K_M.gguf?download=true',
    ...
    ModelDefinition(
      ...
      downloadUrl: 'https://huggingface.co/bartowski/google_gemma-4-E4B-it-GGUF/resolve/main/google_gemma-4-E4B-it-Q4_K_M.gguf?download=true',
    ...
    ModelDefinition(
      ...
      downloadUrl: 'https://huggingface.co/bartowski/google_gemma-3-1b-it-GGUF/resolve/main/google_gemma-3-1b-it-Q4_K_M.gguf?download=true',
    ...
    ModelDefinition(
      ...
      sizeLabel: '743MB',
      sizeBytes: 779100160,
      downloadUrl: 'https://huggingface.co/bartowski/Llama-3.2-1B-Instruct-GGUF/resolve/main/Llama-3.2-1B-Instruct-IQ4_XS.gguf?download=true',
